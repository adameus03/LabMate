...
int main() {
    ...
    // const uint8_t new_access_passwd[4] = {
    //     //0x12, 0x34, 0x56, 0x78
    //     0x00, 0x00, 0x00, 0x00
    //     //0x77, 0x77, 0x77, 0x77
    // };
    // mem_bank = UHFMAN_TAG_MEM_BANK_RESERVED;
    // wordPtr = UHFMAN_TAG_MEM_RESERVED_WORD_PTR_ACCESS_PASSWD;
    // wordCount = UHFMAN_TAG_MEM_RESERVED_WORD_COUNT_ACCESS_PASSWD;
    // pc = 0xFFFF;
    // pEPC = NULL;
    // epc_len = 0;
    // resp_err = 0;
