...
#  Input: 13 x 4 x 2 x 4 (num tags x num antennas x num measurements per tag per antenna x num features per measurement)
...
class Model(nn.Module):
  ...
  def forward(self, input: torch.Tensor, cell_states: Tuple[torch.Tensor, torch.Tensor, torch.Tensor], hidden_states: Tuple[torch.Tensor, torch.Tensor, torch.Tensor]) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
    ...
    return c1new,c2new,c3new,h1new,h2new,h3new
