...
def train_on_sequences_optimized(
    ...
    """
    Optimized training with batching, mixed precision, and DataLoader
    ...
    for epoch in range(num_epochs):
        ...
        for batch_inputs, batch_outputs in pbar:
            ...
            # batch_outputs: (batch_size, sequence_length, 3)
...
if __name__ == "__main__":
    ...
    best_loss = train_on_sequences_optimized(
        model, 
    ...
    # Load best model
    # checkpoint = torch.load('best_rfid_model.pth')
